  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        h2: ['clamp(2rem, 3vw + 1rem, 3.5rem)', { lineHeight: '1', letterSpacing: '-0.04em', fontWeight: '600' }],
        h3: ['clamp(1.75rem, 1.5vw + 1.375rem, 3rem)', { lineHeight: '1.2', letterSpacing: '-0.035em', fontWeight: '500' }],
